...
<%-- 
    ...
    Created on : 24/09/2019, 08:09:16 AM
    ...
    <body>
     ...
     <h1>Tratamientos</h1>
        <form action="Tratamiento" method="post">
            ...
            <input type="text" value="" name="txtnombre" class="form-control"><br>
            <label>descripcion</label>
            <input type="text"  value="" name="txtdescripcion" class="form-control"><br>
            <label>valor</label>
            <input type="double" name="" value="txtvalor" class="form-control"><br>
